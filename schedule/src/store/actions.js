...
export const actionCreator = {
  ...
  changeColumnsVisible: (data) => ({
    type: actionTypes.CHANGE_TABLE_COLUMN_VISIBLE,
    data,
  }),
  changeUserModalWindowVisible: (data) => ({
  ...
  changePermanentEvent: (data) => ({
    type: actionTypes.CHANGE_PERMANENT_EVENT,
    data,
  }),
  changeHightlitedRowStatus: (data) => ({
    type: actionTypes.CHANGE_ROWS_HIGTHLITED_STATUS,
    data,
  }),
  changeHightlitedRows: (data) => ({
    type: actionTypes.CHANGE_HIGHTLITED_ROWS,
    data,
  }),
  changeVisibleRows: (data) => ({
    type: actionTypes.CHANGE_VISIBLE_ROWS,
    data,
  }),
